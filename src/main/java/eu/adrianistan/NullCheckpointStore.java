...
/* Taken from https://github.com/Azure/azure-sdk-for-java/blob/master/sdk/eventhubs/azure-messaging-eventhubs/src/samples/java/com/azure/messaging/eventhubs/SampleCheckpointStore.java */
 ...
 */
public class NullCheckpointStore implements CheckpointStore {
    ...
    private final ClientLogger logger = new ClientLogger(NullCheckpointStore.class);
